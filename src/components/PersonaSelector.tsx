...
const personas: {
...
}[] = [
  {
    ...
    tagline: "Will question your market fit & life choices",
    tag: "TECH",
  },
  {
    id: "fashionista",
    emoji: "👗",
    name: "The Mean Fashionista",
    tagline: "Your style is giving... corporate funeral",
    tag: "STYLE",
  },
  {
    id: "mom",
    emoji: "😤",
    name: "The Disappointed Mom",
    tagline: "You had so much potential, sweetie",
    tag: "LIFE",
  },
];
